...
public class NinePatchTest implements ApplicationListener {
	...
	@Override public void create () {
		...
		nw.region.flip(false, true); // Flip for use with y down coordinate
		// system.
		layout.register(nw);
		...
		n.region.flip(false, true); // Flip for use with y down coordinate
		// system.
		layout.register(n);
		...
		w.region.flip(false, true); // Flip for use with y down coordinate
		// system.
		layout.register(w);
		...
		bg.region.flip(false, true); // Flip for use with y down coordinate
		// system.
		layout.register(bg);
